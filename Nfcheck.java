...
class Nfcheck
{
   static String nfc(HashSet<String> relation, HashMap<ArrayList<String>,ArrayList<String>> h)
  {
  ...
  static  ArrayList<HashSet<String>> findprime(HashMap<ArrayList<String>,ArrayList<String>> h,HashSet<String> relation,HashSet<String>prime)
  {
	  int min=1000;
...
static void findclousre(HashSet<String> dup,  HashMap<ArrayList<String>,ArrayList<String>> h)
{
...
static boolean findtwonf(ArrayList<HashSet<String>> cand, HashSet<String> prime, HashMap<ArrayList<String>,ArrayList<String>> h) {
...
static boolean propersubset(HashSet<String> check,ArrayList<HashSet<String>> cand)
{
	int flag=1;
...
static boolean findthreenf(ArrayList<HashSet<String>> cand, HashSet<String> prime, HashMap<ArrayList<String>,ArrayList<String>> h) {
	int mainflag=0;
	for(ArrayList<String> left: h.keySet())
	{
		int flag=1;
...
static boolean findbcnf(ArrayList<HashSet<String>> cand, HashSet<String> prime, HashMap<ArrayList<String>,ArrayList<String>> h) {
   for(ArrayList<String> left:h.keySet()){
   HashSet<String> check =new HashSet<String>();
		for(String s:left)
			check.add(s);
...
static boolean findcand(HashSet<String> check,ArrayList<HashSet<String>> cand){
